...
export default function StockTransferPage() {
  ...
  // Check availability for a specific line
  ...
  const needsSource =
    entryType === "Material Transfer" || entryType === "Material Issue";
  const needsTarget =
    entryType === "Material Receipt" || entryType === "Material Transfer";
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await createStockMovement(payload);
      setSuccess(res.name);
      addToast({
        ...
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <p className="text-muted-foreground mt-2 max-w-sm mx-auto">
              Stock Entry <strong>{success}</strong> has been created and
              submitted.
            </p>
  ...
  const activeTypeConfig = MOVEMENT_TYPES.find((t) => t.value === entryType)!;
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Create a stock entry to move materials between warehouses
        </p>
      </div>
                ...
                {needsTarget && (
                  <div className="space-y-1.5">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        updateLine(line.id, { t_warehouse: v })
                      }
                    >
                      <SelectTrigger className="w-full text-xs">
                ...
                <div className="flex items-center gap-3 text-xs">
                  {(() => {
                    ...
                    const isInsufficient =
                      line.availability.available_qty < line.qty;
                    return (
                      <>
                        <span
                          className={cn(
